...
void CAbilityWrathBtn::Initialize()
{
	m_iFrameWidth = 18;
	m_iFrameHeight = 18;
	...
	m_wsFrameKey = L"AbilityBackgroundButton_Wrath";
	GET(CResourceMgr)->Insert_Bmp(L"../Resources/Images/UI/Ability/AbilityBackgroundButton_Wrath.bmp", L"AbilityBackgroundButton_Wrath");
}

int CAbilityWrathBtn::Update()
{
	__super::Update_Rect();
...
void CAbilityWrathBtn::Late_Update()
{

}

void CAbilityWrathBtn::Render(HDC hDC)
{
...
void CAbilityWrathBtn::Release()
{

}

void CAbilityWrathBtn::Clicked()
{
	if (m_bMouseOn)
	{
