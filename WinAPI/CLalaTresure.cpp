...
#include "CLala.h"
CLalaTresure::CLalaTresure() : m_bIsClear(false), m_bOpen(false), m_bCompleteDropGold(false)
{
}

CLalaTresure::~CLalaTresure()
{
	Release();
}

void CLalaTresure::Initialize()
{
	CNPC::Initialize();
...
void CLalaTresure::Render(HDC hDC)
{
	if (!m_bIsClear)
		return;
...
void CLalaTresure::Release()
{

}

void CLalaTresure::KeyInput()
{
	if (m_bIsInPlayer)
	{
...
void CLalaTresure::Motion_Change()
{
