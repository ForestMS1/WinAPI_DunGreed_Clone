...
void CNPC_Giant::Initialize()
{
	...
	GET(CResourceMgr)->Insert_Bmp(L"../Resources/Images/Unit/NPC/NPC_Giant.bmp", L"NPC_Giant");

	GET(CUIMgr)->Insert_UI(L"ShopUI", new CShopUI);
}

int CNPC_Giant::Update()
{
	CNPC::Update();
...
void CNPC_Giant::Late_Update()
{
	CNPC::Late_Update();
}

void CNPC_Giant::Render(HDC hDC)
{
	CNPC::Render(hDC);
...
void CNPC_Giant::Release()
{

}

void CNPC_Giant::KeyInput()
{
	if (m_bIsInPlayer)
	{
