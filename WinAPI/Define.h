...
enum OBJ_LAYER{ OBJ_PLAYER, OBJ_PLAYER_BULLET, OBJ_ENEMY_BULLET, OBJ_MONSTER, OBJ_SHIELD, OBJ_END };

enum SCENEID{ SCENE_LOGO, SCENE_TEST, SCENE_MAPTOOL, SCENE_END};

enum TILE_OPTION{ ERASE, BLOCKED, BLOCKED_UPHILL, BLOCKED_DOWNHILL, SPACIOUS, SPACIOUS_UPHILL, SPACIOUS_DOWNHILL, BACKGROUND, END };

enum RENDERID { BACK, GAMEOBJECT, PLAYER, EFFECT, UI, RENDER_END };
